...
public final class DynamicDepositApiConstants {
    ...
    public static final Set<String> DYNAMIC_DEPOSIT_PRODUCT_REQUEST_DATA_PARAMETERS = Set.of("locale", "name", "shortName", "description",
            ...
            allowWithdrawalParamName, dynamicRateEnabledParamName, minDepositTermParamName, maxDepositTermParamName,
            minDepositTermTypeIdParamName, maxDepositTermTypeIdParamName, inMultiplesOfDepositTermParamName,
            inMultiplesOfDepositTermTypeIdParamName, minDepositAmountParamName, maxDepositAmountParamName, depositAmountParamName,
            withHoldTaxPostingTypeIdParamName, SavingProductAccountingParams.SAVINGS_REFERENCE.getValue(),
            SavingProductAccountingParams.SAVINGS_CONTROL.getValue(), SavingProductAccountingParams.TRANSFERS_SUSPENSE.getValue(),
            SavingProductAccountingParams.INTEREST_ON_SAVINGS.getValue(), SavingProductAccountingParams.INCOME_FROM_FEES.getValue(),
            SavingProductAccountingParams.INCOME_FROM_PENALTIES.getValue(), SavingProductAccountingParams.FEES_RECEIVABLE.getValue(),
            SavingProductAccountingParams.PENALTIES_RECEIVABLE.getValue(), SavingProductAccountingParams.INTEREST_PAYABLE.getValue(),
