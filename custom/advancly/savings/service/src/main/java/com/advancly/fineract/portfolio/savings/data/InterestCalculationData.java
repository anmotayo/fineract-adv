 ...
 * figures are always the REAL, already-recorded amounts - a simulated withdrawal is not run through the early
 * withdrawal charge calculation, so they don't reflect what a simulated withdrawal would incur.
 */
